...
public class MeterReading {
    ...
    public String toString() {
        ...
        float lval = value;
        if(Math.abs(lval) > 1.13*max) {//1.2 gives wrong value for 1 k and 1 M resistance
            return "OUT OF RANGE";
        }
    ...
    public static MeterReading ohmUI(MeterReading m0, MeterReading m1) {//for Ω 4-wire method
        float res=1e9f;
        if (m0.value!=0) {res=(m1.value-m0.value*.01f)//shunt resistor is 0.1 Ω
            /m0.value;}
